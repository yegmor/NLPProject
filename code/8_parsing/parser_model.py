...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        # self.embed_to_hidden_bias = nn.Parameter(torch.tensor(self.hidden_size, dtype=torch.float))
        ...
        # self.hidden_to_logits_bias = nn.Parameter(torch.tensor(self.n_classes, dtype=torch.float))
    ...
    def forward(self, w):
        ...
        logits = torch.matmul(h_dropped, self.hidden_to_logits_weight) + self.hidden_to_logits_bias
